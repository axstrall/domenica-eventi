...
export function AdminPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto pt-24 space-y-12 pb-20 font-sans">
      ...
      <section className="bg-white p-8 rounded-[3rem] shadow-xl border border-rose-100">
        ...
        <div className="grid gap-4 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar">
          {filteredProducts.map(p => (
            <div key={p.id} className="flex items-center justify-between p-5 bg-gray-50 rounded-[2rem] border border-gray-100 hover:bg-rose-50/30 transition-all">
      ...
      {/* 4. RUBRICA CLIENTI (RIPRISTINATA) */}
      <section className="bg-white p-8 rounded-[3rem] shadow-xl border border-rose-100">
